...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome to Lachung, Gangtok, India. Hope you are enjoying the virtual experience. You can ask me to tell about the place or its location';
