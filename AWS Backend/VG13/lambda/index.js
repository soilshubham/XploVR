...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome to the Miho Shrine, Matsue. Hope you are enjoying the virtual experience. You can ask me to tell about Miho Shrine or its history';
